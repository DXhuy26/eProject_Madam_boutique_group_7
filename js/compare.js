    ...
    function myAppend() {
        ...
        for (i = 0; i < ds.length; ++i) {
            ...
            $("#showshop").append(
                ...
                '<a href = "' + ds[i].id + '.html" target = "_blank"><img src="' + ds[i].link0 + '" class="img-responsive ep_fade ep_fade_0 card" style="width:100%" alt="Image"></a>' +
                '<p>' + ds[i].id + '</p>' +
                '<p>$' + ds[i].cost + '</p>' +
